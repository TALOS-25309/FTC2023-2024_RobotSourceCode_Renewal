...
public class AutoOpModeRightBack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        AutoOpModeLeft.Command[] command_procedure = {
                ...
                /* 1. */ AutoOpModeLeft.Command.DETECT_PIXELS,
                ///* 2. */ AutoOpModeLeft.Command.DROP_PIXELS,
                /* 3. */ AutoOpModeLeft.Command.PARK
        };
    ...
    public void nextStep() {
        ...
        if (cmd == AutoOpModeLeft.Command.RESET) {
            switch (this.step) {
                case 0:
        ...
        else if (cmd == AutoOpModeLeft.Command.DETECT_PIXELS) {
            switch (this.step) {
                case 0:
        ...
        } else if (cmd == AutoOpModeLeft.Command.DROP_PIXELS) {
            switch (this.step) {
                case 0:
                    // turn arm
        ...
        } else if (cmd == AutoOpModeLeft.Command.PARK) {
            switch (this.step) {
                case 0:
                    // move back a little
                    WheelPart.auto_wheel_move_dir = WheelPart.Direction.Backward;
