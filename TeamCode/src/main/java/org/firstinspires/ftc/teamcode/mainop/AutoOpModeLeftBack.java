...
public class AutoOpModeLeftBack extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        AutoOpModeRight.Command[] command_procedure = {
                ...
                /* 1. */ AutoOpModeRight.Command.DETECT_PIXELS,
                ///* 2. */ AutoOpModeRight.Command.DROP_PIXELS,
                /* 3. */ AutoOpModeRight.Command.PARK
        };
    ...
    public void nextStep() {
        ...
        if (cmd == AutoOpModeRight.Command.RESET) {
            switch (this.step) {
                case 0:
        ...
        else if (cmd == AutoOpModeRight.Command.DETECT_PIXELS) {
            switch (this.step) {
                case 0:
        ...
        } else if (cmd == AutoOpModeRight.Command.DROP_PIXELS) {
            switch (this.step) {
                case 0:
                    // turn arm
        ...
        } else if (cmd == AutoOpModeRight.Command.PARK) {
            switch (this.step) {
                case 0:
                    // move back a little
                    WheelPart.auto_wheel_move_dir = WheelPart.Direction.Backward;
                ...
                case 2:
                    //WheelPart.auto_wheel_move_dir = WheelPart.Direction.Right;
                    //WheelPart.auto_wheel_move_length = 850 + (2-pixelPos) * 260;
                    //wheel_part.startStep(WheelPart.Command.AUTO_MOVE);
                    break;
                case 3:
                    // move back a little
